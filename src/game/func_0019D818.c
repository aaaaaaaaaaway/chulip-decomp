...
typedef struct { int sema; int *rbuf; int rsize; char name[0x400]; } StrPkt;
...
int func_0019D818(unsigned char *path, int rpc) {
    ...
    pkt->rbuf = &result;
    pkt->rsize = 4;
    if (func_0019B760(D_002E3C00, rpc, 0, &D_002E2940, i + 0xD, D_002E3580, 4, 0, 0) < 0) {
        func_001987B0(sema);
        func_0019C418();
        return -11;
    }
