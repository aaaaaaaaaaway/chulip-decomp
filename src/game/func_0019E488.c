...
int func_0019E488(unsigned char *path, Blk *src, int arg) {
    ...
    pkt->rbuf = &result;
    pkt->rsize = 4;
    func_0019AE70(&D_002E2940, 0x450);
    if (func_0019B760(D_002E3C00, 13, 0, &D_002E2940, i + 0x51, D_002E3580, 4, 0, 0) < 0) {
        func_001987B0(sema);
        func_0019C418();
        return -11;
    }
