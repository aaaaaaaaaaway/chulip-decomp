...
int func_0019F350(unsigned char *path, void *buf, unsigned int size) {
    ...
    pkt->rbuf = &result;
    pkt->rsize = 4;
    if (func_0019B760(D_002E3C00, 25, 0, &D_002E2940, 0x80C, D_002E3580, 4, 0, 0) < 0) {
        func_001987B0(sema);
        func_0019C418();
        return -11;
    }
