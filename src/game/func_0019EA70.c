...
int func_0019EA70(unsigned char *path1, unsigned char *path2, int arg, unsigned char *src, int size) {
    ...
    pkt->rbuf = &result;
    pkt->rsize = 4;
    func_0019AE70(&D_002E2940, 0xC14);
    if (func_0019B760(D_002E3C00, 20, 0, &D_002E2940, 0xC14, D_002E3580, 4, 0, 0) < 0) {
        func_001987B0(sema);
        func_0019C418();
        return -11;
    }
