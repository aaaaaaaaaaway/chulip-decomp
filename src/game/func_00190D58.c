...
extern int D_002DF180[];
extern void func_00190CD0(void *param);
...
int func_00190D58(int arg, int arg1, char *path, void *param) {
    int rc;
    ...
    D_002DEC70.f0 = arg;
    D_002DEC70.f4 = arg1;
    D_002DEC70.f10 = (int)D_002DF180;
    func_00192B90(D_002DEC70.name, path, 0x3FF);
    D_002DEC70.name[0x3FF] = 0;
    func_0019AE70(D_002DF180, 0x400);
    rc = func_0019B760(&D_002DEBC0, 0xC, 1, &D_002DEC70, 0x414, D_002E0180, 4, func_00190CD0, param);
    if (rc == 0) {
        D_001E4BC0[0] = 0xC;
    } else {
        func_001987C0(D_001E4BC4[0]);
