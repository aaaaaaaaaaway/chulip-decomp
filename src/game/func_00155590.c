...
void func_00154A00(unsigned short kind, unsigned short index);
unsigned short func_00154700(unsigned short kind);
Node *func_00155AB0(unsigned short index);
void func_0018A680(void *dst, void *src);

unsigned short func_00155590(unsigned short index, unsigned short kind) {
    ...
    if (entry->u.p.owner == 0) {
        func_00154A00(kind, index);
        entry->id = func_00154700(kind);
