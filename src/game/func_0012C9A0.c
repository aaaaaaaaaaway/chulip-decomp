...
void func_0012C9A0(unsigned short slot, unsigned short value) {
    int i;
    ...
    if (i < D_001A5008[slot].count) {
        for (; i < D_001A5008[slot].count - 1; i++) {
            D_001A5008[slot].entries[i] = D_001A5008[slot].entries[i + 1];
        }
