...
int func_00191558(int arg0, int arg1, const char *name) {
    int result;
    ...
    D_002DEC70.unk0 = arg0;
    D_002DEC70.unk4 = arg1;
    func_00192B90(D_002DEC70.name, name, 0x3FF);
    D_002DEC70.name[0x3FF] = 0;
    result = func_0019B760(D_002DEBC0, 0x12, 1, (int *)&D_002DEC70, 0x414,
                           D_002E0180, 4, 0, 0);
    if (result == 0) {
        D_001E4BC0[0] = 0x12;
    } else {
