...
typedef struct { int sema; int *rbuf; int rsize; int pad; int mode; char name[0x400]; } StrPkt;
...
int func_0019E8D8(unsigned char *path, int mode) {
    ...
    pkt->rbuf = &result;
    pkt->rsize = 4;
    if (func_0019B760(D_002E3C00, 19, 0, &D_002E2940, 0x414, D_002E3580, 4, 0, 0) < 0) {
        func_001987B0(sema);
        func_0019C418();
        return -11;
    }
