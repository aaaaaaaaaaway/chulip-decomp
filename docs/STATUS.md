...
Source-reconstructed in exact current build: **24 functions / 1,428 bytes**

Promoted matched functions: **22 / 2,189 (1.0050%)**

Promoted matched text bytes: **1,380 / 663,704 (0.2079%)**
